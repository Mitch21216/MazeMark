  ...
  return (
    <Container fluid className="home-banner-container" onClick={() => closeSideBar() }>
        <Row className="home-banner-title-row" >
            <h1 className="home-banner-title">Welcome to <i>MAZE-MARK</i></h1>
            <span className="home-banner-title-span">A Fresh Theme For Creative bussinesses & individuals </span>
